...
func (x *GeneralReward) Reset() {
	*x = GeneralReward{}
	if protoimpl.UnsafeEnabled {
		mi := &file_GeneraReward_proto_msgTypes[0]
...
func (*GeneralReward) Descriptor() ([]byte, []int) {
	return file_GeneraReward_proto_rawDescGZIP(), []int{0}
}
...
var File_GeneraReward_proto protoreflect.FileDescriptor

var file_GeneraReward_proto_rawDesc = []byte{
	0x0a, 0x12, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x2e, 0x70,
	...
	0x04, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x0b, 0x5a, 0x09,
	0x2f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_GeneraReward_proto_rawDescOnce sync.Once
	file_GeneraReward_proto_rawDescData = file_GeneraReward_proto_rawDesc
)

func file_GeneraReward_proto_rawDescGZIP() []byte {
	file_GeneraReward_proto_rawDescOnce.Do(func() {
		file_GeneraReward_proto_rawDescData = protoimpl.X.CompressGZIP(file_GeneraReward_proto_rawDescData)
	})
	return file_GeneraReward_proto_rawDescData
}

var file_GeneraReward_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_GeneraReward_proto_goTypes = []interface{}{
...
var file_GeneraReward_proto_depIdxs = []int32{
...
func init() { file_GeneraReward_proto_init() }
func file_GeneraReward_proto_init() {
	if File_GeneraReward_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_GeneraReward_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_GeneraReward_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_GeneraReward_proto_goTypes,
		DependencyIndexes: file_GeneraReward_proto_depIdxs,
		MessageInfos:      file_GeneraReward_proto_msgTypes,
	}.Build()
	File_GeneraReward_proto = out.File
	file_GeneraReward_proto_rawDesc = nil
	file_GeneraReward_proto_goTypes = nil
	file_GeneraReward_proto_depIdxs = nil
}
